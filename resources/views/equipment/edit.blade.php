                    ...
                    <form method="POST" action="{{ route('equipment.update', $equipment) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $equipment->name) }}"
                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white @error('name') border-red-500 @endif"
                                required>
                            @error('name')
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="category" id="category" value="{{ old('category', $equipment->category) }}"
                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
                                required>
                            @error('category')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="status" id="status"
                                ...
                                <option value="in_repair" {{ old('status', $equipment->status) === 'in_repair' ? 'selected' : '' }}>In Repair</option>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="description" id="description" rows="4"
                                class="mt-1 block w-full border border-gray-300 rounded-md shadow-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:text-white">{{ old('description', $equipment->description) }}</textarea>
                            @error('description')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
